...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    JLabel lblname, lblage, lblgender, lbljob, lblsalary, lblphone, lblemail, lblcpf, image;
    ...
    AddEmployee() {
        ...
        lblcpf.setBounds(60, 380, 120, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            String query = "insert into employee values('"+name+"', '"+age+"', '"+gender+"', '"+job+"', '"+salary+"', '"+phone+"', '"+email+"', '"+cpf+"')";
